...
public class HarnessWorkIsolationIntegration {
    ...
    public HarnessWorkIsolationIntegration() {
        this.stateManager = new IsolationStateManager();
        this.codeDetector = new CodeStatusDetector();
        this.stateReset = new IsolationStateReset();
        this.ui = new EnhancedIsolationUI();
    }
    ...
    public IsolationDecision handlePhaseABranchIsolation(String taskId, String taskTitle, String worktreePath) {
        ...
        try {
            ...
            IsolationDecision decision = handleUserInteraction(state, taskId, taskTitle, worktreePath);
    ...
    private String extractPhaseName(String taskId) {
        try {
            ...
            return "phase-" + (phaseNum / 10); // Assuming task numbers like 17.1 -> phase 17
        } catch (Exception e) {
